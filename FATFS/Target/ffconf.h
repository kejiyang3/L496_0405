...
#define _USE_MUTEX       1 /* 0:Disable or 1:Enable ? enable priority inheritance */
#define _FS_TIMEOUT      50   /* Timeout period in unit of time ticks ? reduced from 1000 to avoid blocking ECG */
