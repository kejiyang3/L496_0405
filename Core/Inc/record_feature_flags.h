...
#define RECORD_ENABLE_AUDIO RECORD_EXPERIMENT_ENABLE_MIC
...
#define RECORD_DIAG_CASE 0
  ...
  #define RECORD_DIAG_AUDIO_TASK_CREATE   (RECORD_EXPERIMENT_ENABLE_MIC)
  #define RECORD_DIAG_AUDIO_EN_MIC_ON     (RECORD_EXPERIMENT_ENABLE_MIC)
  #define RECORD_DIAG_AUDIO_SAI_DMA       (RECORD_EXPERIMENT_ENABLE_MIC_DMA)
  #define RECORD_DIAG_AUDIO_MIC_PACK      (RECORD_EXPERIMENT_ENABLE_MIC_DMA)
  #define RECORD_DIAG_AUDIO_MIC_SD_WRITE  (RECORD_EXPERIMENT_ENABLE_WAV)
  #define RECORD_DIAG_ECG_ONLY_MODE       0
#endif
...
#define RECORD_REQUIRE_PPG_FOR_FOUR_MODAL RECORD_EXPERIMENT_ENABLE_PPG
#define RECORD_REQUIRE_ICM_FOR_FOUR_MODAL RECORD_EXPERIMENT_ENABLE_ICM
...
#define RECORD_FIX_AUDIO_NONBLOCKING_DISCARD 0  /* no aggregation, but skip periodic sync */
